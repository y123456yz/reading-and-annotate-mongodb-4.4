...
//可以提前了解下2PC https://www.cnblogs.com/qdhxhz/p/11167025.html
//协调者节点（coordinator）CoordinatorCommitDecision和N个参与者节点（partcipant） TransactionParticipant
...
private:
    ...
    struct PrivateState {
        ...
        ////OpObserverImpl::onDelete  OpObserverImpl::onUpdate中赋值
