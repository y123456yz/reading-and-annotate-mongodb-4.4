...
//commitUnpreparedTransaction中调用，获取oplog信息
...
//CmdCommitTxn::run  applyCommitTransaction中调用
void TransactionParticipant::Participant::commitPreparedTransaction(
    ...
    try {
        ...
        UninterruptibleLockGuard noInterrupt(opCtx->lockState());
		//WiredTigerRecoveryUnit::setCommitTimestamp
...
{
		   "type" : "idleSession",
		   "host" : "localhost.localdomain:33331",
		   "desc" : "inactive transaction",
		   "client" : "192.168.153.128:47176",
		   "connectionId" : NumberLong(11),
		   ...
		   "lsid" : {
				   "id" : UUID("3a6aedbb-8bb8-45f8-b991-c94b610a64d7"),
		   ...
		   "transaction" : {
				   ...
				   "startWallClockTime" : "2021-07-30T17:06:27.842+0800",
				   "timeOpenMicros" : NumberLong(10879780),
				   "timeActiveMicros" : NumberLong(146),
				   "timeInactiveMicros" : NumberLong(10879634),
				   "expiryTime" : "2021-07-30T17:07:27.842+0800"
		   },
...
*/
// db.currentOp()获取的打印
//MongoInterfaceStandalone::_reportCurrentOpsForIdleSessions
...
//MongoInterfaceStandalone::_reportCurrentOpForClient
...
//TransactionParticipant::Participant::_logSlowTransaction中调用
